  ...
  def load_record(self):
    ...
    #============================================  
        ...
        for row in record5:
            ...
            rec = my_conn.execute(f"SELECT * FROM cbt_test_score WHERE user_id={loginid} AND test_id={test_id} AND question_id={ques_id} ORDER By id DESC")
            record = rec.fetchall()
            for row1 in record: 
                res_id = row1[0]
                res_user_id = row1[1]
        ...
        #=======================================================
                ...
                self.treev.insert("", 'end', values =(res_batch_id, total_correct, total_wrong))
